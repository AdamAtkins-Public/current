...
if __name__ == '__main__':
    ...
    matrix = []
    row = int(-1)
    with open("Project_Euler\python\data\p082_matrix.txt") as data:
        while True:
    ...
    for row in range(row_max):
        matrix[row][0].set_distance(matrix[row][0].value())
    ...
    print('Solution:{} Runtime:{}'.format(min_distance,time.time()-stime))
